...
# Source files
SRCS = is_prime_pl.cpp unit_tests.cpp CondensedInteger.cpp ModElement.cpp many_carmichaels.cpp
...
test:  test_main.cpp is_prime_pl.o CondensedInteger.o ModElement.o unit_tests.o many_carmichaels.o
	$(CXX) $^ -o $@ $(CXXFLAGS)
